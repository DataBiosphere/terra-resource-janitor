...
export TRACK_RESOURCE_PUBSUB_ENABLED=true
export TRACK_RESOURCE_PUBSUB_PROJECT_ID=terra-kernel-k8s
export TRACK_RESOURCE_PUBSUB_SUBSCRIPTION=crljanitor-rtitle-subscription
