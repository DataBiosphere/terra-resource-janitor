...
/** Flight to clean up an Azure Container Instance. */
public class AzureContainerInstanceCleanupFlight extends Flight {
  public AzureContainerInstanceCleanupFlight(FlightMap inputParameters, Object applicationContext) {
    ...
    addStep(new AzureContainerInstanceCleanupStep(crlConfiguration, janitorDao), retryRule);
