...
public class AzureDatabaseCleanupFlight extends Flight {
  public AzureDatabaseCleanupFlight(FlightMap inputParameters, Object applicationContext) {
    ...
    addStep(new AzureDatabaseCleanupStep(crlConfiguration, janitorDao), retryRule);
