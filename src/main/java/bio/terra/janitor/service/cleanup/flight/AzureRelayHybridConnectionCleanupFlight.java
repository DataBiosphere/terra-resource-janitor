...
public class AzureRelayHybridConnectionCleanupFlight extends Flight {
  public AzureRelayHybridConnectionCleanupFlight(
    ...
    addStep(new AzureRelayHybridConnectionCleanupStep(crlConfiguration, janitorDao), retryRule);
