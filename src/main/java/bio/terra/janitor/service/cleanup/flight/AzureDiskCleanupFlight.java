...
public class AzureDiskCleanupFlight extends Flight {
  public AzureDiskCleanupFlight(FlightMap inputParameters, Object applicationContext) {
    ...
    addStep(new AzureDiskCleanupStep(crlConfiguration, janitorDao), retryRule);
