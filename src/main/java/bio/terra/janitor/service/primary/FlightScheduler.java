...
public class FlightScheduler {
    ...
    private void scheduleFlights() {
        ...
        List<TrackedResource> resources = janitorDao.retrieveSchedulableResources(Instant.now(), SCHEDULE_FLIGHT_LIMIT);
        for (TrackedResource resource : resources) {
            ...
            // er what if the flight finishes before we update its initiating state? should the flight do that?
        }
